...
import { careerOutcomeValenceFeedbackAdmissionDeclarations } from "../outcome-valence-feedback-admission-declaration-persistence/postgres-schema";

export const careerOutcomeValenceFeedbackTargetDeclarations = pgTable(
  "career_outcome_valence_feedback_target_declarations",
  {
    careerOutcomeValenceFeedbackTargetDeclarationId: text("career_outcome_valence_feedback_target_declaration_id").primaryKey(),
    ...
    payload: jsonb("payload").$type<CareerOutcomeValenceFeedbackTargetDeclaration>().notNull(),
  },
);

export const careerOutcomeValenceFeedbackTargetDeclarationSubjects = pgTable(
  ...
  table => [primaryKey({ columns: [
    table.careerOutcomeValenceFeedbackTargetDeclarationId,
    table.recommendationProposalId,
    table.sourceEvolutionInputItemOrdinal,
  ] })],
);

export const careerOutcomeValenceFeedbackTargetDeclarationEvidenceReferences = pgTable(
