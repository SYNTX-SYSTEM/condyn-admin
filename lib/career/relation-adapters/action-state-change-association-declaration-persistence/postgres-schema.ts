...
import { careerStateChangeDeclarations } from "../state-change-declaration-persistence/postgres-schema";

export const careerActionStateChangeAssociationDeclarations = pgTable(
  "career_action_state_change_association_declarations",
  {
    careerActionStateChangeAssociationDeclarationId: text("career_action_state_change_association_declaration_id").primaryKey(),
    ...
    payload: jsonb("payload").$type<CareerActionStateChangeAssociationDeclaration>().notNull(),
  },
);

export const careerActionStateChangeAssociationDeclarationSubjects = pgTable(
  "career_action_state_change_association_declaration_subjects",
  {
    ...
    careerActionStateChangeAssociationDeclarationId: text("career_action_state_change_association_declaration_id").notNull()
      .references(() => careerActionStateChangeAssociationDeclarations.careerActionStateChangeAssociationDeclarationId, { onDelete: "restrict", onUpdate: "restrict" }),
    recommendationProposalId: text("recommendation_proposal_id").notNull(),
    sourceEvolutionInputItemOrdinal: integer("source_evolution_input_item_ordinal").notNull(),
  },
);

export const careerActionStateChangeAssociationDeclarationEvidenceReferences = pgTable(
