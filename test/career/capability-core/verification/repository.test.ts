...
const verificationRun: CapabilityVerificationRun = { runKind: "CAPABILITY_VERIFICATION", verificationRunId: "VFY_0123456789ABCDEF01234567", convergenceRunId: "CONV_0123456789ABCDEF01234567", convergenceRawOutputHash: "a".repeat(64), kernelVersion: "verification-kernel", promptChecksum: "verification-prompt", inference: { provider: "gemini", model: "verification-model" }, schemaVersion: "verification-schema", algorithmVersion: "algorithm", rawOutputHash: "b".repeat(64), status: "COMPLETED", payload: { semanticDefinitionOutcomes: [{ provisionalCapabilityId, status: "PASSED" }], demonstratedLevelOutcomes: [{ provisionalCapabilityId, status: "UNVERIFIED", demonstratedCapabilityLevel: null }], relationDispositions: [], publicationEligibility: "ELIGIBLE" }, createdAt, completedAt: createdAt };
