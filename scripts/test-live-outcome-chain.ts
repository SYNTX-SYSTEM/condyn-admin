...
/**
 * Live execution script for TEST003C Acceptance Gate
 * Runs the full outcome chain proof against real parsed data.
 */
async function main() {
  console.log("==================================================");
  console.log("TEST003C LIVE OUTCOME CHAIN VERIFICATION");
  console.log("==================================================");
...
Worked at TechCorp (a US based SOFTWARE company) for 5 years leading a team of 4 engineers.
  ...
  console.log("\\n7. Outcome arrives later (e.g. from ATS)...");
  const t4 = new Date(new Date(t3).getTime() + 86400000 * 2).toISOString(); // 2 days later
  ...
  if (supported && supported.capabilityProof) {
    ...
    console.log("\\n[SUCCESS] Full Outcome-to-Source Proof Chain Closed.");
  } else {
